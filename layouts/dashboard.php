...
<head>
	...
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/toko.ico" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/toko.png" class="brand">
			<div class="user">Toko Fahreza</div>
		</header>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023. Designed by Fahreza Shiddiq Siregar
		</footer>
	</main>
